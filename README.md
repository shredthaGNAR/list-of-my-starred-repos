...
* [hoothin/SearchJumper](https://github.com/hoothin/SearchJumper): A user script to assist in switching search engines, can also search selected text, image, link using a variety of menus and shortcuts. build with React.js & Material-UI
