...
* [garywill/BigSearch](https://github.com/garywill/BigSearch): Handily use/switch any One or Multiple (uninterruptedly) search engines via a Flexible Tool! Highly Customizable! 大术专搜，既专又广。以 灵活顺手的工具 使用(切换)任意一个 或 (连续)多个 搜索引擎 🔎🌐
...
* [anewuser/firefox-clean-dark-theme](https://github.com/anewuser/firefox-clean-dark-theme): Firefox 91+ dark theme with a less cluttered UI
...
* [baileylatimer/gosun_dev](https://github.com/baileylatimer/gosun_dev): Built for GoSun (gosun.co). Made with ♥ by Latimer Design. 
...
* [117649/SavedPasswordEditorRedux](https://github.com/117649/SavedPasswordEditorRedux): Gecko application to allow creating and editing saved passwords 
...
* [younessidbakkasse/workflow](https://github.com/younessidbakkasse/workflow): Modern Shopify development workflow ⚙️, with Online Store 2.0 features. Built with performance ⚡️ and best practices in mind.. 
