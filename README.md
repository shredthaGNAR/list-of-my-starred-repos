...
* [XInTheDark/raycast-g4f](https://github.com/XInTheDark/raycast-g4f): Raycast extension to use GPT-4o, Claude, Llama-3.1, and more... all for FREE. No API Key required!
